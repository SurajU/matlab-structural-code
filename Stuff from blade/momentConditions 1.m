function m = momentConditions(mChoice,Param,otherInfo,uniformDrawsLambda,lambdaArray,...
...
for t = 2:Param.T
    ...
    indicator4 = [ones(size(aboveDeductibleGroup,1),1);zeros(8000 - size...
...
% Getting all the covariates together. For the second moment, the constant
% is not used. 
